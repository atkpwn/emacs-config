...
#+startup: show2levels
#+property: header-args:emacs-lisp :tangle ./org-config.el

* Basic
  For more =custom-face=, see a very nice [[https://zzamboni.org/post/beautifying-org-mode-in-emacs][blog post]] by Diego Zamboni.
...
* Org Modern
  Use basic setup from the [[https://github.com/minad/org-modern][README]].
  #+begin_src emacs-lisp
...
* Modern Indent
  Conflict with org-modern indentation
  #+begin_src emacs-lisp
